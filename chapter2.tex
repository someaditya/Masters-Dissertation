...
\begin{tabular}{ |c|c|c| } 
 ...
 \hline
\end{tabular}
\caption{Human Evaluation : Yamata et al's model and IBM Model 5.}\label{sbmtt}
\end{table}
...
\caption{Non-factored Translation. Adapted from \cite{Koehn:2007:MOS:1557769.1557821}} \label{fig1}
\end{figure}
